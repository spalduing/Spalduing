...
private:
    ...
    Node *tail;
public:
    Queue():l_size(0),head(NULL),tail(NULL){}
...
public:
    ...
    T first(){return q.getHead()->getValue();}
...
int main()
{
    ...
    try{
        ...
        cout<<"This queue was implemented with the SingleLinkedList class"<<endl;
    ...
    try{
        ...
        cout << endl;
        cout<<"This queue was build from zero using the SingleLinkedList class"<<endl;

        /*while(!q.isEmpty()){
            cout<<q.pick_front()<<endl;
            q.de_queue();
        }*/
